...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'All Sites':
        fig = px.pie(spacex_df, values='class', names='Launch Site', title='Success Launch Counts for all Launch site')
        return fig
    else:
        ...
        fig = px.pie(site_df,values='class count',names='class',title=f'Success Launch counts for launch site {entered_site}')
        return fig
